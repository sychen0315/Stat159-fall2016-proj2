...
eda_barplot(credit_df$Gender, "Barplot of Gender", "../../images/barplot-gender.png")
eda_barplot(credit_df$Student, "Barplot of Student", "../../images/barplot-student.png")
eda_barplot(credit_df$Married, "Barplot of Married", "../../images/barplot-married.png")
eda_barplot(credit_df$Ethnicity, "Barplot of Ethnicity", "../../images/barplot-ethnicity.png")
...
png('../../images/boxplot-Balance-conditional-Gender.png')
...
png('../../images/boxplot-Balance-conditional-Student.png')
...
png('../../images/boxplot-Balance-conditional-Married.png')
...
png('../../images/boxplot-Balance-conditional-Ethnicity.png')
