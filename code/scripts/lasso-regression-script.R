...
lasso_cv_out <- cv.glmnet(x_trainning, y_trainning, alpha=1, lambda = grid, intercept = FALSE,
                          standardize = FALSE)
...
# Refit the model
out <- glmnet(x, y, alpha = 1, lambda = grid,intercept = FALSE, standardize = FALSE)
